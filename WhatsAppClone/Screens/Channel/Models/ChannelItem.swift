...
//  WhatsAppClone
//
//  Created by Jeremy Koo on 5/10/24.
//
...
struct ChannelItem: Identifiable, Hashable {
    ...
    var members: [UserItem] // fetch just for the client side
    ...
    private var groupMemberNames: String {
        let membersCount = membersCount - 1 // subtract currently logged in user
...
extension String {
    ...
    static let thumbnailUrl = "thumnailUrl"
